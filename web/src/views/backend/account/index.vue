...
const baTable = new baTableClass(
    new baTableApi('/admin/Account/'),
    {
        ...
        column: [
            ...
            { label: t('account.openid'), prop: 'openid', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE', sortable: false },
            { label: t('account.nickname'), prop: 'nickname', align: 'center', operatorPlaceholder: t('Fuzzy query'), operator: 'LIKE', sortable: false },
            { label: t('account.avatar'), prop: 'avatar', align: 'center', render: 'image', operator: false },
